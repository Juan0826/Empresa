...
url = "http://localhost:55511/PaginasWeb/EliminarTrabajador.aspx"
...
try:
    ...
    for index, row in islice(df.iterrows(), NroFila, None):
        ...
        element = driver.find_element_by_xpath('//*[@id="ContentPlaceHolder1_Btn_BuscarEli"]')
        driver.execute_script("arguments[0].click();", element)
      
       
        element = driver.find_element_by_xpath('//*[@id="ContentPlaceHolder1_btn_Eliminar"]')
        driver.execute_script("arguments[0].click();", element)   
